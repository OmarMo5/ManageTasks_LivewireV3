<div class="w-7/12">
    @if ($this->tasksByStatus->count() > 0)
        <livewire:tasks-count :tasksByStatus="$this->tasksByStatus" />
    @endif
    <div class="px-6">
        @if(isset($this->showTask))
            @foreach ($this->showTask as $task)
                <div
                    ...
                    <div class="p-4 leading-normal">
                        <div class="flex justify-between mb-4">
                            ...
                            <span
                                class="px-2 py-1 border border-slate-200 rounded-md flex justify-end">{{ $task->deadline->diffForHumans() }}
                            </span>
                        </div>
